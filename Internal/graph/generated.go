...
type ComplexityRoot struct {
	...
	Query struct {
		Comment  func(childComplexity int, postID int) int
...
type QueryResolver interface {
	...
	Comment(ctx context.Context, postID int) (*model.Comment, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.comment":
		...
		return e.complexity.Query.Comment(childComplexity, args["postId"].(int)), true
...
func (ec *executionContext) _Query_comment(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Comment(rctx, fc.Args["postId"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
